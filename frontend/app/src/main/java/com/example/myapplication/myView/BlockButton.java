 ...
 * >
 * </com.example.androidapp.component.BlockButton>
 * <p>
 * java:
 * boolean isPressed()
 */
 ...
 * 屏蔽按钮，带动画
 */
public class BlockButton extends androidx.appcompat.widget.AppCompatButton implements View.OnClickListener {
    ...
    private String text_pressed = "已屏蔽";
    private String text = "+ 屏蔽";
    ...
    private boolean pressed = false;// true：已屏蔽
    ...
    public BlockButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        setOnClickListener(BlockButton.this);
